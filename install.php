...
function com_install()
{
	...
	try
	{
		...
		$database->setQuery( "CREATE TABLE #__form_field ( id serial, form int(10), name varchar(255), type varchar(10), length int(10), sort_order int(10), description text )" );
		$database->Query();

		$database->setQuery( "CREATE TABLE #__field_option ( id serial, field int(10), name varchar(255), value varchar(255) )" );
		$database->Query();

		$database->setQuery( "CREATE TABLE #__field_validation ( id serial, field int(10), type varchar(10), vars text )" );
		$database->Query();
